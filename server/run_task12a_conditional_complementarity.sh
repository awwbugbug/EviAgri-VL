...
PROJECT=/root/EviAgri-VL/task12a_code_20260727_protocol_v1
...
ROOT=/root/autodl-tmp/EviAgriDiag/experiments/task12a_conditional_complementarity/2026-07-27/protocol_v1/attempt_01
...
test "$(sha256sum "$BASE_FEATURES/features.npy" | cut -d' ' -f1)" = 5c730bab8d37d125f430d6b2fae1721359c04818f1dd86682e2f33a1ebbcaccc
test "$(sha256sum "$PLANTSEG_FEATURES/features.npy" | cut -d' ' -f1)" = e05f01467c70ec334656f1702e1e0ec8fd4c5d8a14a7dad1616b9d98fc62b618
...
"$PY_BASE" "$PROJECT/build_task12a_local_dataset.py" \
  ...
  --prior-crop-manifest "$PRIOR_CROP" --output-root "$ROOT/dataset"
...
"$PY_VISION" "$PROJECT/extract_task10b_features.py" \
  ...
  --config-version task12a-local-feature-config-1 \
  --summary-version task12a-local-feature-summary-1
